...
class ProduitSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Produit
        fields = ['identifiant_produit','nom_produit','image_produit','description_produit','prix_unitaire_produit','quantite_produit_disponible','seuil_alerte_produit','categorie_produit','date_creation','date_modification']
